...
from src.audio import create_transform, ReadAudio
...
def load_wav_dataset(n_jobs, use_gpu, pin_memory, ascending, corpus, audio, text):
    ...
    dv_audio_reader = ReadAudio(SAMPLE_RATE, mode='dev', time_aug=audio['time_aug'])
    ...
    collect_dv = partial(collect_wav_batch, audio_reader=dv_audio_reader, mode='test')
